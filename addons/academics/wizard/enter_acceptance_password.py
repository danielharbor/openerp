...
class enter_acceptance_password(osv.osv_memory):
    _name = "enter.acceptance.password"
    ...
    def accept_applicant(self, cr, uid, ids, context=None):
        ...
        return self.pool.get('aun.applicant').case_accept(cr, uid, context['active_ids'], context)

enter_acceptance_password()
